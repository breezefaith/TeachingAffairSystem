...
import teaching.affair.system.pojo.Schedule;
 ...
 * 
 * @see teaching.affair.system.pojo.Schedule
...
public class ScheduleDAO extends BaseHibernateDAO {
	...
	public Schedule findById(java.lang.Integer id) {
		...
		try {
			Schedule instance = (Schedule) getSession().get("teaching.affair.system.pojo.Schedule", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Schedule instance) {
		...
		try {
			List results = getSession().createCriteria("teaching.affair.system.pojo.Schedule")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Schedule instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Schedule as model where model." + propertyName + "= ?";
