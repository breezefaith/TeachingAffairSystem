 ...
 * 
 * @see teaching.affair.system.pojo.Semester
...
public class SemesterDAO extends BaseHibernateDAO {
	...
	public Semester findById(java.lang.Integer id) {
		...
		try {
			Semester instance = (Semester) getSession().get("teaching.affair.system.pojo.Semester", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Semester instance) {
		...
		try {
			List results = getSession().createCriteria("teaching.affair.system.pojo.Semester")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Semester instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Semester as model where model." + propertyName + "= ?";
