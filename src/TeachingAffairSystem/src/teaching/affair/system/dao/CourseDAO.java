 ...
 * 
 * @see teaching.affair.system.pojo.Course
...
public class CourseDAO extends BaseHibernateDAO {
	...
	public static final String COURSE_ACADEMY = "courseAcademy";
	...
	public Course findById(java.lang.String id) {
		...
		try {
			...
			Course instance = (Course) getSession().get("teaching.affair.system.pojo.Course", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Course instance) {
		...
		try {
			List results = getSession().createCriteria("teaching.affair.system.pojo.Course")
	...
	public List findByCourseAcademy(Object courseAcademy) {
		return findByProperty(COURSE_ACADEMY, courseAcademy);
	}

	public List findByCourseCategory(Object courseCategory) {
		return findByProperty(COURSE_CATEGORY, courseCategory);
	}
