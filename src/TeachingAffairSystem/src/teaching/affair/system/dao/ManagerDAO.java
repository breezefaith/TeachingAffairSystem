 ...
 * 
 * @see teaching.affair.system.pojo.Manager
...
public class ManagerDAO extends BaseHibernateDAO {
	...
	public Manager findById(java.lang.Integer id) {
		...
		try {
			Manager instance = (Manager) getSession().get("teaching.affair.system.pojo.Manager", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Manager instance) {
		...
		try {
			List results = getSession().createCriteria("teaching.affair.system.pojo.Manager")
