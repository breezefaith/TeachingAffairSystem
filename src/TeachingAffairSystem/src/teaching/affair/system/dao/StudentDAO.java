 ...
 * 
 * @see teaching.affair.system.pojo.Student
...
public class StudentDAO extends BaseHibernateDAO {
	...
	public static final String STUDENT_ACADEMY = "studentAcademy";
	public static final String STUDENT_MAJOR = "studentMajor";
	...
	public Student findById(java.lang.String id) {
		...
		try {
			Student instance = (Student) getSession().get("teaching.affair.system.pojo.Student", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Student instance) {
		...
		try {
			List results = getSession().createCriteria("teaching.affair.system.pojo.Student")
	...
	public List findByStudentAcademy(Object studentAcademy) {
		return findByProperty(STUDENT_ACADEMY, studentAcademy);
	}

	public List findByStudentMajor(Object studentMajor) {
		return findByProperty(STUDENT_MAJOR, studentMajor);
	}
